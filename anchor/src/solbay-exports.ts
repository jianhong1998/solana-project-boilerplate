...
export function getSolbayProgram(provider: AnchorProvider, address?: PublicKey) {
  return new Program({ ...SolbayIDL, address: address ? address.toBase58() : SolbayIDL.address } as Solbay, provider)
}
